...
public class Breakout extends BreakoutProgram {
	...
	private boolean noBricks = false;
	...
	private void youWin(){
		...
		WIN.setLocation((getWidth()-WIN.getWidth()) / 2, (getHeight() - WIN.getHeight()) / 2);
		add(WIN);	
	}
